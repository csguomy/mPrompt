...
class AEBatch(nn.Module):
    ...
    def forward(self, estimated_density_map, gt_num):
        ...
        #return torch.abs(torch.sum(estimated_density_map) - gt_num)
...
class SEBatch(nn.Module):
    ...
    def forward(self, estimated_density_map, gt_num):
        ...
        #return torch.pow(torch.sum(estimated_density_map) - gt_num, 2)
        
class AEBatch_vit(nn.Module):
    def __init__(self):
        super(AEBatch_vit, self).__init__()

    def forward(self, estimated_density_map, gt_num):
        return torch.abs(torch.sum(estimated_density_map, dim=(1, 2)) - gt_num)



class SEBatch_vit(nn.Module):
    def __init__(self):
        super(SEBatch_vit, self).__init__()

    def forward(self, estimated_density_map, gt_num):
        return torch.pow(torch.sum(estimated_density_map, dim=(1, 2)) - gt_num, 2)
